...
public:
    ...
    QTableWidget *table_shift_view;
    QWidget *tab_edit_people;
    QTableWidget *table_people_view;
    ...
    void setupUi(QMainWindow *Scheduler)
    {
        ...
        table_shift_view = new QTableWidget(tab_view_placement);
        if (table_shift_view->columnCount() < 4)
            table_shift_view->setColumnCount(4);
        QTableWidgetItem *__qtablewidgetitem = new QTableWidgetItem();
        table_shift_view->setHorizontalHeaderItem(0, __qtablewidgetitem);
        QTableWidgetItem *__qtablewidgetitem1 = new QTableWidgetItem();
        table_shift_view->setHorizontalHeaderItem(1, __qtablewidgetitem1);
        QTableWidgetItem *__qtablewidgetitem2 = new QTableWidgetItem();
        table_shift_view->setHorizontalHeaderItem(2, __qtablewidgetitem2);
        QTableWidgetItem *__qtablewidgetitem3 = new QTableWidgetItem();
        table_shift_view->setHorizontalHeaderItem(3, __qtablewidgetitem3);
        if (table_shift_view->rowCount() < 1)
            table_shift_view->setRowCount(1);
        QTableWidgetItem *__qtablewidgetitem4 = new QTableWidgetItem();
        table_shift_view->setVerticalHeaderItem(0, __qtablewidgetitem4);
        table_shift_view->setObjectName(QString::fromUtf8("table_shift_view"));
        table_shift_view->setGeometry(QRect(0, 0, 761, 451));
        ...
        table_people_view = new QTableWidget(tab_edit_people);
        if (table_people_view->columnCount() < 3)
            table_people_view->setColumnCount(3);
        QTableWidgetItem *__qtablewidgetitem5 = new QTableWidgetItem();
        table_people_view->setHorizontalHeaderItem(0, __qtablewidgetitem5);
        QTableWidgetItem *__qtablewidgetitem6 = new QTableWidgetItem();
        table_people_view->setHorizontalHeaderItem(1, __qtablewidgetitem6);
        QTableWidgetItem *__qtablewidgetitem7 = new QTableWidgetItem();
        table_people_view->setHorizontalHeaderItem(2, __qtablewidgetitem7);
        table_people_view->setObjectName(QString::fromUtf8("table_people_view"));
        table_people_view->setGeometry(QRect(0, 0, 761, 451));
        ...
        verticalLayout->addWidget(button_export);
        ...
        QObject::connect(actionExit, &QAction::triggered, actionExit, qOverload<>(&QAction::trigger));
        QObject::connect(button_export, &QPushButton::pressed, actionExport, qOverload<>(&QAction::trigger));
    ...
    void retranslateUi(QMainWindow *Scheduler)
    {
        ...
        label->setText(QCoreApplication::translate("Scheduler", "TextLabel", nullptr));
        ...
        QTableWidgetItem *___qtablewidgetitem = table_shift_view->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("Scheduler", "Date", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = table_shift_view->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("Scheduler", "Building", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = table_shift_view->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("Scheduler", "Primary", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = table_shift_view->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QCoreApplication::translate("Scheduler", "Seconday", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = table_shift_view->verticalHeaderItem(0);
        ...
        QTableWidgetItem *___qtablewidgetitem5 = table_people_view->horizontalHeaderItem(0);
        ___qtablewidgetitem5->setText(QCoreApplication::translate("Scheduler", "Name", nullptr));
        QTableWidgetItem *___qtablewidgetitem6 = table_people_view->horizontalHeaderItem(1);
        ___qtablewidgetitem6->setText(QCoreApplication::translate("Scheduler", "Primary Count", nullptr));
        QTableWidgetItem *___qtablewidgetitem7 = table_people_view->horizontalHeaderItem(2);
        ___qtablewidgetitem7->setText(QCoreApplication::translate("Scheduler", "Secondary Count", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_edit_people), QCoreApplication::translate("Scheduler", "Edit People File", nullptr));
        button_export->setText(QCoreApplication::translate("Scheduler", "Export to Disk", nullptr));
